...
import logo from "../assets/Polygon 2.png";
...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between bg-[#3EC3C1] py-4 px-4 md:px-8 text-white shadow-md relative">
            <div className="relative flex items-center h-10 w-20">
                <img src={logo} alt="Logo" className="absolute left-0 top-0 h-10 w-10" />
                <span className="relative left-1 text-lg font-bold text-white">TOTC</span>
            </div>
