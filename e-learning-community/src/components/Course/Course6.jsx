...
const Course6 = () => {
  ...
  return (
    <div className="w-full px-4 mt-16 mb-16  py-12">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6 px-2 sm:px-4">
          <h2 className="text-xl sm:text-2xl font-semibold ml-0 sm:ml-2 md:ml-4 lg:ml-6">The course in personal development</h2>
